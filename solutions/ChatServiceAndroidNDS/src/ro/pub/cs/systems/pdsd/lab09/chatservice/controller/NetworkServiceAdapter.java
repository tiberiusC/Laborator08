package ro.pub.cs.systems.pdsd.lab09.chatservice.controller;
...
public class NetworkServiceAdapter extends BaseAdapter {
	...
	private class NetworkServiceConnectButtonClickListener implements Button.OnClickListener {
		...
		public void onClick(View view) {
			ChatConversationFragment chatConversationFragment = new ChatConversationFragment(clientPosition, clientType);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			networkServiceViewHolder.networkServiceNameTextView = (TextView)view.findViewById(R.id.network_service_name_text_view);
